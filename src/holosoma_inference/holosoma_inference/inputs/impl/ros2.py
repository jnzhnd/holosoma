...
class Ros2Input(InputProvider):
    ...
    def start(self) -> None:
        ...
        self._logger.info(f"Subscribed to ROS2 velocity: {self._vel_topic}, commands: {self._cmd_topic}")  # noqa: G004
    ...
    def _cmd_callback(self, msg):
        ...
        if cmd is not None:
            ...
            self._logger.warning(f"ROS2 command: unknown command '{cmd_str}'")  # noqa: G004
